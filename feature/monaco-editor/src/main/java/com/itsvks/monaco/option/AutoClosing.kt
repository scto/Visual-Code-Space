...
@JvmInline
value class EditorAutoClosingStrategy private constructor(override val value: String) :
    Option<String> {
    companion object {
...
@JvmInline
value class EditorAutoClosingEditStrategy private constructor(override val value: String) :
    Option<String> {
    companion object {
