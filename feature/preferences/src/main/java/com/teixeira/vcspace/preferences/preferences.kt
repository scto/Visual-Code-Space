...
val isLocalDarkTheme
    get() = appearanceUIMode == AppCompatDelegate.MODE_NIGHT_YES
val isLocalFollowSystemTheme
    get() = appearanceUIMode == AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM
