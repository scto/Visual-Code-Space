...
class CommandPaletteManager private constructor() {
    companion object {
        @JvmStatic val instance by lazy { CommandPaletteManager() }
    ...
    val recentlyUsedCommands
        get() = _recentlyUsedCommands.toList()
    ...
    fun addRecentlyUsedCommand(command: Command) {
        ...
        if (_recentlyUsedCommands.size > 10) {
            _recentlyUsedCommands.removeAt(
                _recentlyUsedCommands.lastIndex
