...
data class DocumentFileWrapper(
    ...
    companion object {
         ...
         *
         * The implementation is conservative as a lot of functionality stops working when
         * [DocumentFileWrapper] is used. The target implementation will accept all content uris for
         * custom [androidx.core.content.FileProvider]s.
         */
