...
protected constructor(
    ...
    @JvmField var languageConfiguration: LanguageConfiguration?,
    ...
    /**
     * When you update the [TextMateColorScheme] for editor, you need to synchronize the updates
     * here
     *
        ...
        fun prepareLoad(
            ...
            if (languageConfiguration != null) {
                languageRegistry.languageConfigurationToGrammar(
                    LanguageConfiguration.load(languageConfiguration),
                    grammar,
                )
            }
