        ...
        pluginsPath.listFiles()?.forEach { file ->
            ...
            if (!properties.exists()) {
                throw IllegalArgumentException(
                    "Plugin directory ${file.name} does not contain plugin.properties"
                )
            }
            ...
            } ?: runOnUiThread { showShortToast(context, "Plugin file not found for ${file.name}") }
        }
