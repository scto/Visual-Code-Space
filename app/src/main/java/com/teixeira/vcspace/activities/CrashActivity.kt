...
class CrashActivity : BaseComposeActivity() {
    ...
    override fun MainScreen() {
        ...
        Scaffold(
            ...
            topBar = { CrashTopBar(scrollBehavior = scrollBehavior) },
            floatingActionButton = {
                ExtendedFloatingActionButton(
                    onClick = {
                        ...
                        uriHandler.openUri(
                            "https://github.com/Visual-Code-Space/Visual-Code-Space/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title="
                        )
                    },
                    text = { Text(stringResource(strings.copy_and_report)) },
                    icon = {
                        Icon(
            ...
            CrashScreen(modifier = Modifier.padding(innerPadding), error = error)
