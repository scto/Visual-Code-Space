...
class TerminalActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent { VCSpaceTheme { Surface { MainScreen() } } }
    }
                ...
                setupEnvironment(
                    ...
                    onProgress = { completedFiles, totalFiles, currentProgress ->
                        if (needsDownload) {
                            ...
                            progress = combinedProgress.coerceIn(0f, 1f)
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                filesToDownload.forEach { file ->
                    ...
                    runCatching { outputFile.setExecutable(true) }
    ...
    private fun extractPackage(onComplete: () -> Unit) {
        ...
        val libtallocSo2Path =
            File(prefix, "lib/libtalloc.so.2").apply { if (exists()) delete() }.toPath()
