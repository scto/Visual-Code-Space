...
fun PluginsScreen(
    ...
    val expandedFab by remember {
        derivedStateOf { installedPluginListState.firstVisibleItemIndex == 0 }
    }
    ...
    LaunchedEffect(Unit) { viewModel.loadInstalledPlugins(context) }
                    ...
                    viewModel.loadInstalledPlugins(
                        ...
                        onSuccessfullyLoaded = {
                            toastHostState.showToast(
                                message =
                                    "Plugin ${if (pluginToUpdate != null) "updated" else "imported"} successfully",
    ...
    Scaffold(
        ...
        Column(modifier = modifier.padding(innerPadding)) {
            PluginTabs(currentRoute = currentRoute, navController = navController)
