...
class FileViewBinder(
    ...
    override fun bindView(
        ...
        itemView.updateLayoutParams<ViewGroup.MarginLayoutParams> { width = node.depth * 22.dp }
    }
    ...
    override fun onToggle(node: TreeNode<File>, isExpand: Boolean, holder: TreeView.ViewHolder) {
        applyDir(holder, node)
    }
