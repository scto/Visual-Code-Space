        ...
        Column(modifier = Modifier.padding(16.dp).verticalScroll(rememberScrollState())) {
            Row(
                ...
                AnimatedVisibility(visible = showUsageMetadata) {
                    Text(
                        text =
                            "total: ${usageMetadata?.totalTokenCount}, prompt: ${usageMetadata?.promptTokenCount}, candidates: ${usageMetadata?.candidatesTokenCount}",
                        fontSize = 9.sp,
            ...
            MarkdownText(markdown = text, isTextSelectable = true)
        }
    }
}
