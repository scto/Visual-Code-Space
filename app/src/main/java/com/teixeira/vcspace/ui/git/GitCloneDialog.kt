...
fun GitCloneDialog(
    ...
    AlertDialog(
        ...
        title = { Text(text = stringResource(strings.git_clone_repo)) },
        text = {
        ...
        confirmButton = {
            DialogButton(
                ...
                enabled =
                    !isCloneInProgress && gitRemoteUrl.isNotEmpty() && localClonePath.isNotEmpty(),
                onClick = {
                    ioScope.launch {
...
@Composable
private fun Cloning(progress: Int, message: String) {
    Column {
...
@Composable
private fun UrlTextField(url: String, onUrlChange: (String) -> Unit) {
    OutlinedTextField(
        value = url,
        onValueChange = onUrlChange,
        label = { Text(text = stringResource(strings.git_url)) },
    )
}
...
private fun DestinationTextField(
    ...
    OutlinedTextField(
        ...
        label = { Text(text = stringResource(strings.git_destination_path)) },
        trailingIcon = {
