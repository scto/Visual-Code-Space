...
class TerminalService : Service() {
    ...
    @Suppress("PrivatePropertyName") private val ACTION_EXIT = "$packageName.action.ACTION_EXIT"
    ...
    private fun createNotificationChannel() {
        val channel =
            NotificationChannel(CHANNEL_ID, "Session Service", NotificationManager.IMPORTANCE_LOW)
                .apply { description = "Notification for Terminal Service" }
