...
class TerminalBackend(val terminal: TerminalView, val activity: TerminalActivity) :
    ...
    override fun onSessionFinished(finishedSession: TerminalSession) {
        activity.terminalBinder?.terminateSession(
            activity.terminalBinder!!.service.currentSession.value
        )
