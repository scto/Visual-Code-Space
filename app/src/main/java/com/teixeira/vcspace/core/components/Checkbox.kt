    ...
    val toggleableModifier =
        if (onClick != null) {
            Modifier.triStateToggleable(
                ...
                indication = rippleOrFallbackImplementation(bounded = false, radius = size),
            )
        } else {
            Modifier
        }
...
/**
 * Represents the color used for the box (background) of the checkbox, depending on [enabled] and
 * [state].
 *
